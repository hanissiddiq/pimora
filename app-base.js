...
// REGISTER (buat user & kirim email verifikasi)
...
app.get("/auth/verify", async (req, res) => {
  ...
  try {
    ...
    // Optional: auto-login setelah verifikasi
...
// LOGIN (MySQL + cek email terverifikasi)
app.post("/login", async (req, res) => {
  const { username, password } = req.body; // frontend kamu kirim "username", kita treat sebagai email
  ...
  try {
    ...
    // set session (frontend kamu memang memakai sesi untuk auto-login) 
